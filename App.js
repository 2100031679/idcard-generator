    ...
    <div class="flip-card-front">
     <div className='ID'>
      ...
      <div className='third'>
          ...
          <p><b>Name:</b> Varshith Reddy</p>
          <p><b>ID Number:</b> 2100031679</p>
    ...
    <div className='back'>
       <div className='firstb'>
        ...
        <div className='unique'>
          <div className='inner'>
          <h4><b>Address</b></h4>
          <p>Address: Warangal,Hasanparthy,seethampet,HNO:1-65,Telangana, 506371</p>
          <p>Emergency Conact No: 1234567890</p>
          <p>Blood Group: B+</p>
          <p>Email: 2100031679@kluniversity.in</p>
